...
package com.aborovskoy.google.codelabs.geofences
...
import com.aborovskoy.google.codelabs.geofences.databinding.ActivityHuntMainBinding
        ...
        locationSettingsResponseTask.addOnFailureListener { exception ->
            if (exception is ResolvableApiException && resolve) {
                ...
                Snackbar.make(binding.activityMapsMain, R.string.location_required_error, Snackbar.LENGTH_INDEFINITE)
                        .setAction(android.R.string.ok) { checkDeviceLocationSettingsAndStartGeofence() }.show()
            }
        }
